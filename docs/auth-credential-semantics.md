...
Initial turn model selection can reacquire current auth facts once after checking
run authority. A second invalidation stops preparation; this never repeats inference.
