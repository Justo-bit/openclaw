...
export class ComposerEditor extends HTMLElement {
  ...
  constructor() {
    ...
    style.textContent = `
      ...
      .composer-chip { display: inline-flex; vertical-align: baseline; align-items: center; gap: 0.3em;
      ...
      .composer-chip__icon { display: inline-flex; flex: 0 0 auto; width: 1em; height: 1em; align-items: center; justify-content: center; }
